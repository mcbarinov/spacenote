...
4. Read `justfile` to see available deploy commands
5. Read `docs/deploy.md` for deployment workflow and server setup
6. Read `deploy/docker-compose.yml` for production configuration
7. Read `deploy/docker-compose.local.yml` for local stack configuration
8. Read `deploy/.env.example` for environment variables
9. Read `apps/backend/Dockerfile` for backend image setup
10. Read `apps/web/Dockerfile` for web image setup
11. Read `apps/admin/Dockerfile` for admin image setup
