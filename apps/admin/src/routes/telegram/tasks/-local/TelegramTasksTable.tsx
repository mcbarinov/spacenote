...
import { Code, Modal, Paper, Table, Text } from "@mantine/core"
import { SpaceSlug, TextBadge } from "@spacenote/common/components"
        ...
        <Table highlightOnHover>
          ...
          <Table.Tbody>
            {tasks.map((task) => (
              ...
              >
                <Table.Td>
                  <TextBadge color={getStatusColor(task.status)}>{task.status}</TextBadge>
                </Table.Td>
