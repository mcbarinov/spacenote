...
@router.post(
    ...
    description="Add a new filter to an existing space. Requires 'all' permission in the space.",
...
@router.put(
    ...
    description="Update a filter in a space. Requires 'all' permission in the space. "
...
@router.delete(
    ...
    description="Remove a filter from a space. Requires 'all' permission in the space.",
