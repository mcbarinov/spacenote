...
/** Imports a space from JSON export (admin only) */
...
/** Uploads a pending attachment (for image fields) */
...
/** Deletes a pending attachment (admin only) */
