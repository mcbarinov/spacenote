...
export type FormValues = z.infer<typeof fieldSchema>
...
export function parseFieldToFormValues(field: SpaceField): FormValues {
  ...
  if (field.type === "string") {
    ...
    values.stringKind = STRING_KINDS.includes(opts.kind as (typeof STRING_KINDS)[number])
      ? (opts.kind as (typeof STRING_KINDS)[number])
      : "line"
