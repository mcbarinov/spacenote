...
export const Route = createFileRoute("/_auth/_admin/admin/spaces/$slug/fields/$fieldName/edit")({
  ...
  function handleSubmit(values: FormValues) {
    ...
    updateFieldMutation.mutate(updateData, {
      onSuccess: () => {
        ...
        void navigate({ to: "/admin/spaces/$slug/fields", params: { slug } })
      },
    })
  }
    ...
    <Stack gap="md">
      <PageHeader
        breadcrumbs={[
          ...
          { label: `◈ ${space.slug}` },
          { label: "Fields", to: "/admin/spaces/$slug/fields", params: { slug } },
          { label: "Edit Field" },
        ]}
