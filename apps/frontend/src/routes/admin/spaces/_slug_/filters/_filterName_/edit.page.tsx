...
export const Route = createFileRoute("/_auth/_admin/admin/spaces/$slug/filters/$filterName/edit")({
    ...
    <Stack gap="md">
      <PageHeader
        breadcrumbs={[
          ...
          { label: `◈ ${space.slug}` },
          { label: "Filters", to: "/admin/spaces/$slug/filters", params: { slug } },
          ...
          onSubmit={(data) => {
            updateFilterMutation.mutate(data, {
              onSuccess: () => {
                ...
                void navigate({ to: "/admin/spaces/$slug/filters", params: { slug } })
              },
            })
          }}
