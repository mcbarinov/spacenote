...
export type paths = {
    ...
    "/api/v1/spaces/{space_slug}/fields/{field_name}": {
         ...
         * @description Update a field's properties in a space. Requires 'all' permission in the space. Only required, options, and default can be changed. Type and name cannot be modified.
         */
    ...
    "/api/v1/spaces/{space_slug}/filters/{filter_name}": {
         ...
         * @description Update a filter in a space. Requires 'all' permission in the space. If name in body differs from filter_name in URL, the filter will be renamed. The 'all' filter can only have sort and default_columns modified.
         */
    ...
    "/api/v1/spaces/{slug}/admin-access": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["adminJoinSpace"];
        /**
         * Leave space as admin
         * @description System admin removes themselves from a space.
         */
        delete: operations["adminLeaveSpace"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export type components = {
    schemas: {
        ...
        /**
         * BackupInfo
         * @description Metadata for a database backup file.
         */
        BackupInfo: {
            /**
             * Filename
             ...
             * Created At
             * Format: date-time
             * @description Backup creation timestamp (UTC)
             */
            created_at: string;
        };
        ...
        CreateSpaceRequest: {
            ...
            /**
             * Members
             * @description Space members with permissions
             */
         ...
         * @enum {string}
         */
        Permission: "all" | "create_note" | "create_comment";
        /**
        ...
        SpaceField: {
             ...
             */
            options: components["schemas"]["StringFieldOptions"] | components["schemas"]["NumericFieldOptions"] | components["schemas"]["BooleanFieldOptions"] | components["schemas"]["SelectFieldOptions"] | components["schemas"]["TagsFieldOptions"] | components["schemas"]["UserFieldOptions"] | components["schemas"]["DatetimeFieldOptions"] | components["schemas"]["ImageFieldOptions"] | components["schemas"]["RecurrenceFieldOptions"];
            /**
             * Default
        ...
        UpdateMembersRequest: {
            /**
             * Members
             * @description New list of space members with permissions
             */
            members: components["schemas"]["Member"][];
        };
        /**
...
export interface operations {
    ...
    uploadSpaceAttachment: {
        ...
        responses: {
            ...
            /** @description Requires 'create_note' permission */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createComment: {
        ...
        responses: {
            ...
            /** @description Requires 'create_comment' permission */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    deleteComment: {
        ...
        responses: {
            ...
            /** @description Requires 'create_comment' permission and comment authorship */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    adminJoinSpace: {
        ...
        requestBody?: never;
        responses: {
            /** @description Successfully joined space */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    adminLeaveSpace: {
        ...
        requestBody?: never;
        responses: {
            /** @description Successfully left space */
            200: {
                headers: {
                    [name: string]: unknown;
                };
