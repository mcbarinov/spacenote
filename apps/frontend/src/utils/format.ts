...
/** Removes undefined/null values from an object, suitable for URL search params */
export function cleanParams(params?: Record<string, unknown>): Record<string, string | number> {
  if (!params) return {}
  return Object.fromEntries(Object.entries(params).filter(([, v]) => v != null)) as Record<string, string | number>
}
