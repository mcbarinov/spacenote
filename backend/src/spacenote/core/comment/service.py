...
class CommentService(Service):
    ...
    async def create_comment(self, note_id: ObjectId, space_id: ObjectId, author_id: ObjectId, content: str) -> Comment:
    ...
    async def get_note_comments(self, note_id: ObjectId) -> list[Comment]:
